...
export const procurementOrders = sqliteTable("procurement_orders", {
  ...
  customsBrokerName: text("customs_broker_name"),
  customsReleaseStatus: text("customs_release_status"),
  customsReleasedAt: text("customs_released_at"),
  estimatedDutyCny: real("estimated_duty_cny"),
  estimatedVatCny: real("estimated_vat_cny"),
  actualTaxPaidCny: real("actual_tax_paid_cny"),
  customsInspectionStatus: text("customs_inspection_status"),
  createdByUserId: text("created_by_user_id").notNull(),
