...
export const procurementOrders = sqliteTable("procurement_orders", {
  ...
  warehouseInboundNo: text("warehouse_inbound_no"),
  warehouseInboundAt: text("warehouse_inbound_at"),
  receivedBoxes: integer("received_boxes"),
  damagedBoxes: integer("damaged_boxes"),
  shortageBoxes: integer("shortage_boxes"),
  sortingBatchNo: text("sorting_batch_no"),
  allocationStatus: text("allocation_status"),
  domesticCarrierName: text("domestic_carrier_name"),
  domesticDeliveryNo: text("domestic_delivery_no"),
  ...
  deliveredBoxes: integer("delivered_boxes"),
  deliveryStatus: text("delivery_status"),
  signedAt: text("signed_at"),
  signerName: text("signer_name"),
  signedBoxes: integer("signed_boxes"),
  rejectedBoxes: integer("rejected_boxes"),
  receiptStatus: text("receipt_status"),
  damageClaimStatus: text("damage_claim_status"),
  statementNo: text("statement_no"),
  invoiceNo: text("invoice_no"),
  serviceFeeCny: real("service_fee_cny"),
  receivableAmountCny: real("receivable_amount_cny"),
  receivedAmountCny: real("received_amount_cny"),
